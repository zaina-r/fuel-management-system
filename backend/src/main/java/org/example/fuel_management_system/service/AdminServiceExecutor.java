...
@Service
public class AdminServiceExecutor implements AdminService {
    ...
    public AdminServiceExecutor(FuelStationRepository fuelStationRepository, ExistingStationsRepository existingStationsRepository, FuelRepository fuelRepository, FuelAllocationRepository fuelAllocationRepository, StationWithRegistrationStatusRepository stationWithRegistrationStatusRepository){
    ...
    public Response getStationWithStatus() {
        ...
        try {
            ...
            response.setMessage("The station could not be retrieved");
            response.setStationWithStatusDTOList(new ArrayList<>());
        }
    ...
    public Response updateInitialFuelAllocation(Fuel fuelAllocation, int id) {
        ...
        try {
            ...
            response.setMessage("The fuel could not be updated.");
            response.setStatusCode(500);
        }
        return response;
    }
