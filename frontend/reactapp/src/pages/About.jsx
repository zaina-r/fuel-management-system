...
import { FaGasPump, FaChartLine, FaBell, FaTools, FaCheckCircle, FaEnvelope } from "react-icons/fa";

const About = () => {
  const features = [
    { icon: <FaGasPump className="text-green-400 text-3xl" />, title: "Automated Fuel Tracking", desc: "Monitor fuel usage in real time with automated reporting." },
    { icon: <FaChartLine className="text-blue-400 text-3xl" />, title: "Nationwide Integration", desc: "Seamlessly connect with fuel stations across the country." },
    { icon: <FaTools className="text-purple-400 text-3xl" />, title: "User-Friendly Dashboard", desc: "Access insights through a clean and intuitive interface." },
    { icon: <FaBell className="text-red-400 text-3xl" />, title: "Custom Alerts", desc: "Receive notifications for low fuel levels and anomalies." },
    { icon: <FaGasPump className="text-orange-400 text-3xl" />, title: "Efficient Allocation", desc: "Optimize fuel distribution to prevent wastage and ensure availability." },
    { icon: <FaCheckCircle className="text-yellow-400 text-3xl" />, title: "Secure Transactions", desc: "Ensure safe and verified fuel transactions with robust security." },
  ];
  return (
    <div className="p-10 bg-gray-900 text-white">
      <div className="my-28 px-10">
        ...
        <h2 className="text-3xl font-semibold mb-4 text-orange-500 mt-28">
...
<div className="mb-16 my-44 ">
  <h2 className="text-3xl font-semibold mb-14 text-center text-orange-500">🚀 Key <span className="text-blue-500">Features</span></h2>
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    {features.map((feature, index) => (
      <div key={index} className="bg-gray-800 p-6 rounded-xl shadow-lg hover:scale-105 transition-transform duration-300">
